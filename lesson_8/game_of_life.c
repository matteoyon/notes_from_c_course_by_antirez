...
/* Translate the specified x,y grid point to the index in linear array.
 ...
 * required VT100 escape sequenxe */
...
/* Compute new state of game of life according to the rules. */
